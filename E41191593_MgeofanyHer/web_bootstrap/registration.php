            ...
            <div class="col-xl-12" lg-7>
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            <a href="#" class="dropdown-tonggle" role="button" id="dropdownmenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="card-body">
                    ...
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="optradio" value="laki-laki">Laki-laki
                    </label>
                    </div>
                    <div class="form-check form-check-inline">
                    <label class="form-check-label">
                ...
                <textarea class="form-control" rows="3" name="text" id="text" placeholder="Isi disini.."></textarea><br>
                    ...
                    if($name){
                        ...
                        echo " <br><strong>jenis kelamin : </strong> {$optradio} <br>";
                    }              
                    if(isset($_GET['agama'])){
                        $agama = $_GET['agama'];
