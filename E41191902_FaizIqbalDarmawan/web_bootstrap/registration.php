        ...
        <div class="card-body">
            <form>
                ...
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optionradio" value="Laki-laki">Laki-laki
                </label>
                </div>
                <div class="form-check form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optionradio" value="Perempuan">Perempuan
                </label>
                </div>
                <div class="form-group">
                ...
                <textarea class="form-control" rows="4" id="text" name="text" placeholder=""></textarea><br>
                ...
                if ($optionradio) {
                    echo "<strong>Jenis Kelamin:</strong> {$optionradio} <br>";
                }
                if ($agama) {
                    echo "<strong>Agama:</strong> {$agama} <br>";
                }
                if ($text) {
                    echo "<strong>Biodata:</strong> {$text} <br>";
                }
