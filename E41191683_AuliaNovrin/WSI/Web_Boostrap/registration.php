    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <div class="d-sn-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Regristration</h1>
            </div>
                ...
                <div class="col-xl-12 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-o font-weight-bold text-primary">Regristration Form</h6>
                            <div>
                                <a class="dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                    <i class="fas fa-ellipis-v fa-sn fa-fw text-gray-400"></i>
                                </a>
                            </div>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="gender" name="gender" value="Lak-laki" required>Laki-laki <br>
                                    <input type="radio" class="form-check-input" id="gender" name="gender" value="Perempuan" required>Perempuan
                                </div>
                                <div class="form-group">
                                ...
                                <div>
                                    <textarea name="biografi" id="biografi" cols="80" rows="10" placeholder="Biografi Singkat ..."></textarea> 
                                </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; BIGBOSS 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
